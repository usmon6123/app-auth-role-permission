...
public class ApiResult<T> {
    ...
    private T data;
    private List<uz.yengilyechim.payload.ErrorData> errors;
    ...
    public ApiResult(String errorMsg, Integer errorCode) {
        this.success = false;
        this.errors = Collections.singletonList(new uz.yengilyechim.payload.ErrorData(errorMsg, errorCode));
    }

    //ERROR RESPONSE WITH ERROR DATA LIST
    public ApiResult(List<uz.yengilyechim.payload.ErrorData> errors) {
        this.success = false;
        this.errors = errors;
    }
